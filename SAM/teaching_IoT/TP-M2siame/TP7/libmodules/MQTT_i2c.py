...
def do_every_interrupt (worker_func, iterations = 0):
    global timer, light_interleave
    # launch new timer
    if ( iterations != 1):
        timer = threading.Timer (
...
def on_message(client, userdata, msg):
    global temp_interleave, light_interleave, interrupt_mode, capture
...
def main():
    ...
    GPIO.add_event_detect(16,GPIO.FALLING,callback=interrupt)
